Add-PodeRoute -Method Get -Path '/api/settings' -ScriptBlock {
    try {
        $whitelist = @(
            ...
            'scraper.movie.r18dev'
            'scraper.movie.r18dev.source'
            'scraper.movie.javguru'
            'scraper.movie.dmm'
            'scraper.movie.dmmja'
            ...
            'scraper.movie.tokyohot'
            'scraper.movie.tokyohotja'
            'scraper.movie.tokyohotzh'
            'database.r18dump.autorefresh'
            'database.r18dump.maxagedays'
            'web.scrape.javdb.fallback'
            'web.scrape.javguru.fallback'
        )
